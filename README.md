...
- **全局热键启动** — 为常用应用绑定 `Alt/Ctrl/Win + 按键` 快捷键，一键启动或激活窗口，再次按下同一快捷键可最小化窗口
- **窗口循环切换** — 使用 `Alt+\`` 在同一应用的多个窗口间快速切换，支持激活隐藏的托盘窗口（支持自定义按键）
...
4. 保存后即可通过全局热键启动或激活目标应用，再次按下相同快捷键可将窗口最小化到任务栏
